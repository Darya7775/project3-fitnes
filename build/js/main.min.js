...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var buttonBay = document.querySelector('.header__button');
  buttonBay.addEventListener('click', function (e) {
    e.preventDefault();
    var buttonId = buttonBay.getAttribute('href');
  ...
  var gymVideo = document.querySelector('.gym__video-wrapper');
  var gymButton = gymVideo.querySelector('.gym__video-button');
  var gymLink = gymVideo.querySelector('.gym__video-link');
  ...
  var gymPHide = document.querySelector('.gym__wrap--hide');
  var breakpoint = window.matchMedia('(max-width:75em)');
  var deletePgym = function deletePgym() {
  ...
  var tabsList = document.querySelectorAll('.subscription__tabs-list');
  for (var i = 0; i < tabsList.length; i++) {
    tabsList[i].style.display = 'none';
  }
  tabs.forEach(function (tab) {
    if (tab.getAttribute('checked') === '') {
      for (var _i = 0; _i < tabsList.length; _i++) {
        if (tabsList[_i].classList.contains(tab.getAttribute('id'))) {
          tabsList[_i].style.display = 'grid';
        }
      }
    }
  });
  tabs.forEach(function (tab) {
    tab.addEventListener('click', function () {
      var idTab = tab.getAttribute('id');
      for (var _i2 = 0; _i2 < tabsList.length; _i2++) {
        tabsList[_i2].style.display = 'none';
      }
      for (var _i3 = 0; _i3 < tabsList.length; _i3++) {
        if (tabsList[_i3].classList.contains(idTab)) {
          tabsList[_i3].style.display = 'grid';
        }
      }
    });
  });
  ...
  void new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.trainer__swiper', {
    modules: [swiper__WEBPACK_IMPORTED_MODULE_2__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_2__["Keyboard"], swiper__WEBPACK_IMPORTED_MODULE_2__["A11y"]],
    spaceBetween: 40,
    grabCursor: true,
    loop: true,
    navigation: {
  ...
  var slides = document.querySelectorAll('.trainer__item');
  for (var _i4 = 0; _i4 < 4; _i4++) {
    slides[_i4].removeAttribute('tabindex');
  }

  // reviews

  void new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.reviews__swiper', {
  ...
  var _loop = function _loop(_i5) {
    telephones[_i5].addEventListener('input', function () {
      var value = telephones[_i5].value.replace(/\D+/g, '');
      var numberLength = 11;
      var result;
      if (telephones[_i5].value.includes('+8') || telephones[_i5].value[0] === '8') {
        result = '';
      } else {
        result = '+';
      }
      ...
      //
      telephones[_i5].value = result;
    });
  };
  for (var _i5 = 0; _i5 < telephones.length; _i5++) {
    _loop(_i5);
  }
