...
window.addEventListener('DOMContentLoaded', function () {
    ...
    if (tab.getAttribute('checked') === '') {
      for (var _i = 0; _i < tabsList.length; _i++) {
        if (tabsList[_i].classList.contains(tab.getAttribute('id'))) {
          tabsList[_i].style.display = 'flex';
        }
      }
    }
  });
    ...
    tab.addEventListener('click', function () {
      ...
      for (var _i3 = 0; _i3 < tabsList.length; _i3++) {
        if (tabsList[_i3].classList.contains(idTab)) {
          tabsList[_i3].style.display = 'flex';
        }
      }
    });
  });
  ...
  var _loop = function _loop(_i4) {
    telephones[_i4].addEventListener('input', function () {
      var value = telephones[_i4].value.replace(/\D+/g, '');
      var numberLength = 11;
      var result;
      if (telephones[_i4].value.includes('+8') || telephones[_i4].value[0] === '8') {
        result = '';
      } else {
        result = '+';
      }
      ...
      //
      telephones[_i4].value = result;
    });
  };
  for (var _i4 = 0; _i4 < telephones.length; _i4++) {
    _loop(_i4);
  }
